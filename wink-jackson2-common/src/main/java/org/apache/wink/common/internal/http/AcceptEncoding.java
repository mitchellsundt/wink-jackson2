...
public class AcceptEncoding {
    ...
    private static HeaderDelegate<AcceptEncoding> doNotDirectlyAccess = null;

    public static synchronized HeaderDelegate<AcceptEncoding> getAcceptEncodingHeaderDelegate() {
        if (doNotDirectlyAccess == null) {
            RuntimeDelegate delegate = RuntimeDelegate.getInstance();
            doNotDirectlyAccess = delegate.createHeaderDelegate(AcceptEncoding.class);
        }
    ...
    public static AcceptEncoding valueOf(String value) throws IllegalArgumentException {
        return getAcceptEncodingHeaderDelegate().fromString(value);
    }
    ...
    @Override
    public String toString() {
        return getAcceptEncodingHeaderDelegate().toString(this);
    }
}
