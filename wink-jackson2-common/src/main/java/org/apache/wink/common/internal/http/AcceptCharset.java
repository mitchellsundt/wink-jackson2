...
public class AcceptCharset {
    ...
    private static HeaderDelegate<AcceptCharset> doNotDirectlyAccess = null;

    public static synchronized HeaderDelegate<AcceptCharset> getAcceptCharsetHeaderDelegate() {
        if (doNotDirectlyAccess == null) {
            RuntimeDelegate delegate = RuntimeDelegate.getInstance();
            doNotDirectlyAccess = delegate.createHeaderDelegate(AcceptCharset.class);
        }
    ...
    public static AcceptCharset valueOf(String value) throws IllegalArgumentException {
        return getAcceptCharsetHeaderDelegate().fromString(value);
    }
    ...
    @Override
    public String toString() {
        return getAcceptCharsetHeaderDelegate().toString(this);
    }
