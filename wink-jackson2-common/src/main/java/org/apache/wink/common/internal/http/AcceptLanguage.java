...
public class AcceptLanguage {
    ...
    private static HeaderDelegate<AcceptLanguage> doNotDirectlyAccess = null;

    public static synchronized HeaderDelegate<AcceptLanguage> getAcceptLanguageHeaderDelegate() {
        if (doNotDirectlyAccess == null) {
            RuntimeDelegate delegate = RuntimeDelegate.getInstance();
            doNotDirectlyAccess = delegate.createHeaderDelegate(AcceptLanguage.class);
        }
    ...
    public static AcceptLanguage valueOf(String value) throws IllegalArgumentException {
        return getAcceptLanguageHeaderDelegate().fromString(value);
    }
    ...
    public String toString() {
        return getAcceptLanguageHeaderDelegate().toString(this);
    }
