...
public class CsvSerializerProvider implements MessageBodyWriter<CsvSerializer> {
    ...
    private static HeaderDelegate<ContentDispositionHeader> doNotDirectlyAccess        = null;

    public static synchronized HeaderDelegate<ContentDispositionHeader> getContentDispositionHeaderDelegate() {
        if (doNotDirectlyAccess == null) {
            RuntimeDelegate delegate = RuntimeDelegate.getInstance();
            doNotDirectlyAccess = delegate.createHeaderDelegate(ContentDispositionHeader.class);
        }
    ...
    public void writeTo(CsvSerializer t,
        ...
        httpHeaders.putSingle(CONTENT_DISPOSITION_HEADER, getContentDispositionHeaderDelegate()
            .toString(contentDispositionHeader));
