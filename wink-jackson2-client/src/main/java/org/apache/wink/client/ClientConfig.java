...
public class ClientConfig implements Cloneable, WinkConfiguration {
    ...
    private void initDefaultApplication() {
        ...
        // Only set up the ApplicationFileLoader and load the
        // referenced classes if we are configured to load 
        // the default wink-application. Had be loading all
        // the class definitions (if any were found),
        // regardless of whether the defined application was
        // supposed to be loaded.
        if (loadWinkApplications) {
            try {
